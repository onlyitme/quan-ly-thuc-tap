...
<body>
    <header id="header" class="fixed-top shadow-sm border-bottom bg-light">
        <div class="wrap d-flex justify-content-between align-items-center">
                ...
                <div class="d-none d-lg-flex justify-content-end h-100 ">
                    ...
                    <div class="btn-group" role="group">
                        <a id="btnGroupDrop1" type="button"
                            class="dropdown-toggle btn bg-tomato rounded-0  h-100 border-left   p-4"
                        ...
                        <div class="dropdown-menu dropdown-menu-right w-200 " aria-labelledby="btnGroupDrop1">
                            <a class="dropdown-item" href="<?=SITE_URL?>/?ctrl=sinh_vien"><i
                                    class="fas fa-list-alt mr-2"></i> Kiểm Tra Thông Tin </a>
                            <a class="dropdown-item" href="<?=SITE_URL?>/?ctrl=home"><i
                                    class="fas fa-history    mr-2"></i> Lịch Sử Đơn</a>
                            <a class="dropdown-item" href="<?=SITE_URL?>/?ctrl=home&act=logout"><i
                                    class="fas fa-sign-out-alt   mr-2 "></i> Đăng xuất</a>
                        </div>
                    </div>
                    <?php } else { ?>
                    <div class="btn-group" role="group">
                        <a data-toggle="modal" data-target="#exampleModal-Nghia" href="#login"
                            class="btn btn-light rounded-0 h-100 border-left p-4" role="button" aria-pressed="true"><i
                                class="fas fa-edit"></i> Đăng Tin</a>
                        <a id="btnGroupDrop1" type="button"
                            class="dropdown-toggle btn btn-primary  text-light rounded-0  h-100 border-left    p-4"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-user-circle mr-2 "></i> <?=$_SESSION['sname']?>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right  " aria-labelledby="btnGroupDrop1">
                            <a class="dropdown-item" href="<?=SITE_URL?>/?ctrl=doanh_nghiep"><i
                                    class="fas fa-list-alt mr-2"></i> Kiểm Tra Thông Tin </a>
                            <a class="dropdown-item" href="<?=SITE_URL?>/?ctrl=home"><i
                                    class="fas fa-history    mr-2"></i> Danh sách ứng tuyển</a>
                            <a class="dropdown-item" href="<?=SITE_URL?>/?ctrl=home&act=logout"><i
                                    class="fas fa-sign-out-alt   mr-2 "></i> Đăng xuất</a>
                        </div>
                    </div>
            ...
            <div id="header-login" class="col p-0">
                <div class="d-none d-lg-flex justify-content-end h-100 ">
                    <a data-toggle="modal" href="#login" class="btn btn-light rounded-0  h-100 border-left   p-4"
                        role="button" aria-pressed="true">SINH VIÊN</a>
                    <a data-toggle="modal" href="#login" class="btn btn-primary  rounded-0  h-100 border-left    p-4"
                        role="button" aria-pressed="true">DOANH NGHIỆP</a>
                </div>
            </div>
            <?php } ?>
        </div>
                                    ...
                                    <div class="Nghia row">
                                        <div class="col-12">
                                            ...
                                            <div class="row pl-3 mb-1">
                                                    <div class="N-input mb-5 mr-4 "><input type="number" name="luongthapnhat"
                                                            class="N-ip form-control" placeholder="Lương thấp nhất*">
                                                        <span class="VND">VND</span>
                                                    </div>
                                                    <div class="N-input mb-5 "><input type="number"  name="luongcaonhat"
                                                            class="N-ip form-control" placeholder="Lương cao nhất*">
                                                        <span class="VND">VND</span>
                                                    </div>
                                            </div>
                                            <div class="row pl-3 mb-4">
                                                <div class="N-input mb-4 mr-4"><input type="number" name="thoigiantt"
                                                        class="N-ip form-control" placeholder="Thời gian thực tập*">
                                                    <span class="VND">Tháng</span>
                                                </div>
                                                <div class="N-input mb-4 "><input type="number" name="soluongtuyen"
                                                    class="N-ip form-control" placeholder="Số lượng cần tuyển*">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <div class="custom-control custom-checkbox  mb-3">
                                                            <input type="checkbox" class="custom-control-input "
                                                                id="defaultInline3" name="thuong">
                                                            <label class="custom-control-label" for="defaultInline3"> <i
                                                                    class="fas fa-award  text-info  ml-2"></i> Chế độ thưởng</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox  mb-3">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="defaultInline4" name="daotao">
                                                            <label class="custom-control-label" for="defaultInline4"><i
                                                                    class="	fas fa-atom   text-info  ml-2"></i> Chương trình đào tạo</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox  mb-3">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="defaultInline5" name="tangluong">
                                                            <label class="custom-control-label" for="defaultInline5"><i
                                                                    class="fa fa-level-up   text-info  ml-2"></i> Tăng lương</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="custom-control custom-checkbox  mb-3">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="defaultInline6" name="nghiphep">
                                                            <label class="custom-control-label" for="defaultInline6">
                                                                <i class="fas fa-business-time  text-info  ml-2"></i> Nghỉ phép</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox  mb-3">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="defaultInline2" name="dulich">
    ...
    <nav id="nav-togger" class="border shadow-lg">
        <div class="list-group">
            <div class="d-flex d-lg-none  list-group-item list-group-item-action p-0 mb-3">
                <a data-toggle="modal" href="#login" class="btn btn-light rounded-0  h-100 border w-50  py-3"
                    role="button" aria-pressed="true">SINH VIÊN</a>
                <a data-toggle="modal" href="#login" class="btn btn-primary  rounded-0  h-100 border w-50  py-3"
                    role="button" aria-pressed="true">DOANH NGHIỆP</a>
            </div>
            ...
            <button type="button" class="list-group-item list-group-item-action rounded-0  py-3">Hướng dẫn đăngbài</button>
            <button type="button" class="list-group-item list-group-item-action rounded-0  py-3">Hướng dẫn ứngtuyển</button>
        </div>
    </nav>
    <div id="dangtuyen">
