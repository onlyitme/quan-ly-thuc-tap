                            ...
                            <div class="media boder p-3 tt-dau bg-tt">                             
                                <a href="#">
                                    <img  src="view/images/avt1.jpg" alt="John Doe" class="mr-3 mt-3 ml-3 " >
                                </a>                 
                            <div class="thongtin1">
                                <div class=" media-body ml-4"><br>
                                    <h3>Monkey D.Garp </h3>
                                    <p style="width: 100%; ">Sinh Viên Cao Đẳng Fpoly</p> 
                                    <hr class="mr-5" style="background: white;width: 98% ;float: left;">     
                                    <i class="fa fa-phone mr-3" style="font-size: 12pt; transform: scaleX(-1);"></i>
                                    
                                        0123456789 <br>
                                    <i class="fa fa-home mt-3 mr-3" style="font-size: 12pt;"></i> 
                                    
                                        //Bé Lê Văn Đạt, Quận Cam, Sài Gòn.  
                                    </div>
                            </div>
                            </div>
                         <form action="index.php?ctrl=sinh_vien&act=ttcn_update" method="post" id="capnhapttcn">
                            <div class="media boder p-3 sv8-12 mt3">
                                <div class="row col-sm-12">
                                    ...
                                    <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 ml-2">
                                        <p><input type="text" class="form-control mb-2 mr-sm-2"  placeholder="Nhập tên" id="ho_ten"></p>
                                    </div>
                                    ...
                                    <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 ml-2">
                                        <p style="margin-top: -5px;">
                                            <input type="radio" id="male" name="gioi_tinh" value="1">                                   
                                    ...
                                    <div class="col-12 text-center mt-4">
                                        <a href="file:///C:/Users/ASUS/Documents/GitHub/quan-ly-thuc-tap/site/view/sv1-ttcn.html">
