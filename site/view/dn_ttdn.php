            ...
            <div class="row">
                ...
                <div class="col-lg-6 p-3">
                    <button type="button" class="list-group-item list-group-item-action px-0">
                        <div class="media">
                            <img class="card-img-top col-3" src="../uploads/<?=$doanhnghiep['anh']?>"
                                alt="Card image cap" onerror=this.src="view/images/img_login.png">
                            <div class="media-body text-gray text-left">
                                <a href="">
                                    <h5 class="text-dark mt-0 d-inline"><a
                                            href="index.php?act=thongtindt&id_dt=<?= $t['id_dt'] ?>">
                                            <?= $t['tieu_de'] ?></a></h5>
                                </a>
                ...
                <div class="h-box-tq-about">
                    ...
                    <div class="h-tq-about-content">
                        <p>Công Ty Kootoro được thành lập và đặt trụ sở chính tại Mỹ vào năm 2013 và chính thức ra mắt
                            thị trường Việt Nam vào năm 2015. Toro là một ứng dụng thanh toán qua mã QR tiện lợi, được
                            biết đến với nhận diện là Ví Tiết Kiệm Toro.
                        </p>
                        <p>Công ty Kootoro chính thức cho ra mắt chuỗi cửa hàng tự động không người bán đầu tiên tại
                            Việt Nam. Chỉ bằng việc quét mã QR trên ứng dụng điện thoại Ví tiết kiệm TORO, người mua đã
                            dễ dàng thanh toán xong món hàng mà không cần đến
                            nhân viên thu ngân hay phục vụ.</p>
                        <p>Star is a global consultancy that connects strategy, design, engineering and marketing
                            services into a seamless workflow devised to support our clients every step of the way – no
                            matter how long or complex their journey. We anchor
                    ...
                    <div class="h-tq-about-content">
                        <p>Thiết kế và thi công các công trình xây dựng dân dụng & công nghiệp Thi công M&E Định hướng
                            phạm vi của hệ thống QLCL, AT&SKNN sẽ mở rộng trong tương lai là Thiết kế và thi công các
                            công trình hạ tầng, sân đường, công trình cầu cảng,
                            Thi công cơ giới, Cho thuê máy móc thiết bị xây dựng, Kinh doanh vật liệu xây dựng, Sản xuất
                            và kinh doanh kết cấu thép.
                        </p>
                    </div>
                    <h5 class="h-title-h4">Thông điệp từ công ty</h5>
                    <h6 class="h-title-h6">SỨ MỆNH</h6>
                    <div class="h-tq-about-content">
                        <p>Cung cấp các sản phẩm xây dựng dân dụng và công nghiệp có chất lượng cao và giá cả phù hợp
                            thông qua việc đổi mới và ứng dụng công nghệ tiên tiến</p>
                    ...
                    <div class="h-tq-about-content">
                        <p>Trên nền tảng của hệ thống quản lý chất lượng, an toàn & sức khỏe nghề nghiệp đã xây dựng,
                            NAVICONS sẽ từng bước vững chắc phát triển quy mô và công nghệ cũng như đầu tư tài chính để
                            thực hiện tầm nhìn trở thành 1 trong 5 tổng thầu
                    ...
                    <div class="h-tq-about-content">
                        <p>Văn hóa doanh nghiệp là nền tảng cho sự phát triển bền vững. Tại Navicons, đó chính là sự đối
                            xử chân thành và tôn trọng lẫn nhau, hỗ trợ nhau cùng phấn đấu để phát triển.</p>
                    </div>
