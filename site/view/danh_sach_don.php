    ...
    <div class="media col-sm-12 shadow sv-12 NdmH" style="min">
        ...
        <div style="margin-right: 6px;" class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 ds-hva">
            ...
            <p style="margin-bottom:-1px;" class="mb-2">
                ...
                <a  class="text-dark" style="font-size: 10pt;cursor:auto;" href="#"><?=$thong_tin_dn['sdt']?> </a>– <a class="text-dark" style="font-size: 10pt;cursor:auto;"
                    href="#"><?=$thong_tin_dn['sdt_ban']?></a>
            </p>
        </div>
