                            ...
                            <div class="media boder p-3 sv8-12 mt-3 mb-3">
                                <div class="row col-sm-12">
                                    ...
                                    <div  class="col-sm-2 ">
                                        <a class=" btn btn-white-36 " href="index.php?ctrl=sinh_vien&act=cv_edit&trang=3" style="border-radius: 5px;">
                                            <i style="color: black;" class="fa fa-pencil ml-2"></i>
                                            <span class=" text-gray-75 font400 ml-2 mr-2"> Chỉnh sửa</span>
                                        </a>
                                    </div>
                                    ...
                                    <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                        <p>: <?php if(isset($thongtincv['ung_dung_khac']) && $thongtincv['ung_dung_khac'] != '') echo $thongtincv['ung_dung_khac'];else echo 'Không có'?> </p>
                                    </div>
                                    <div class="row"></div>
