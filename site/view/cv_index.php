<div class="media boder p-3 sv8-12 mb-3">
    <div class="row col-sm-12">
        ...
        <div class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 ">
            <a class=" btn btn-warning py-2" href="index.php?ctrl=sinh_vien&act=cv_edit&trang=1"
...
<div class="media boder p-3 sv8-12 mt-3 mb-3">
    <div class="row col-sm-12">
        <div class="col-10 col-sm-10 col-md-10 col-lg-10 col-xl-10 ">
            <h5 style="border-left: 5px rgb(6, 2, 219) solid;padding: 0 5px;">KĨ NĂNG & SỞ TRƯỜNG</h5>
        </div>
        <div class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 ">
            ...
            <a class=" btn btn-warning py-2" href="index.php?ctrl=sinh_vien&act=cv_edit&trang=2"
                style="border-radius: 5px;">
                <i  class="fa fa-pencil"> Chỉnh sửa</i>
            </a>
        </div>
...
<div class="media boder p-3 sv8-12 mt-3 mb-3">
    <div class="row col-sm-12">
        ...
        <div class="col-sm-2 ">
            ...
            <a class=" btn btn-warning py-2"  href="index.php?ctrl=sinh_vien&act=cv_edit&trang=3"
                style="border-radius: 5px;">
                <i  class="fa fa-pencil"> Chỉnh sửa</i>
            </a>
        </div>
        ...
        <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
            <p><?php if(isset($thongtincv['ung_dung_khac']) && $thongtincv['ung_dung_khac'] != '') echo $thongtincv['ung_dung_khac'];else echo 'Không có'?>
            </p>
        </div>
