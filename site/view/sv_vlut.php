<?php 
    ...
    if($dt['ket_qua']==0)$kq='Chưa có';elseif($dt['ket_qua']==1)$kq='Rớt';else $kq='Đạt';
?>
        ...
        <div class="h-vlut-con-left">
            ...
            <div class="h-vlut-tieude">
                <div class="row">
                    ...
                    <div class="col-lg-4"> <label for="" class="mb-3 fw-500"><?=$ttsv['ho_ten']?></label> </div>
                    <div class="col-lg-4 text-right"> Mã SV: <label for="" class="mb-2 "> <?=$ttsv['mssv']?></label> </div>
            ...
            <?php if($dt['ket_qua']!=0){?>
                <div class="h-vlut-nx text-secondary mt-4">
                    ...
                    <div class="h-vlut-nx-con">
                        ...
                        <span class="text-secondary h-nx-text mt-1">
                            <textarea name="" id="" cols="86" rows="6"><?=$dt['danh_gia']?></textarea>
                        </span>
                    </div>
                </div>
                <?php } ?>
        ...
        <div class="h-vlut-con-right border-left px-2">
            <div class="h-border-time rounded">
                ...
                <div class="row mt-1">
                    ...
                    <label class="col-6 text-right text-info"><?php $tg= $dt['thoi_gian_duyet']; $tg = strtotime($tg);echo date("d/m/Y",$tg);?></label>
                 ...
                 <div class="h-vlut-loader"></div><?php }?>
                    ...
                    <!-- Nếu trạng thái = 1 (Đã thực tập xong) thì hiển thị ngày kết thúc -->
                </div>
            </div>
            ...
            <hr class="h-vlut-hr">
            <div class="h-con-right-hinh mt-2">
                <img src="" alt="">
            </div>
        </div>
    </div>
