                            ...
                            <div class="media boder p-3 sv8-12 mb-3">
                                <div class="row col-sm-12" style="background-image: linear-gradient(-25deg, #8a8a8a 0%, #82dcff 100%);margin:auto;">
                                    ...
                                    <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                        <p><input type="text" class="form-control mb-2 mr-sm-2"  placeholder="Tiêu đề" id="tieude"></p>
                                    </div>
                                    <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 ml-4">
                                    ...
                                    <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                        <p>
                                            <select style="width:100%;padding: 6px 0;" name="trinhdo" ><option value="0">Trình độ</option><option value="1">Cao học</option><option value="2">Đại học</option><option value="3">Cao Đẳng</option><option value="4">Trung cấp</option></select>
                                        </p>
                                    </div>
                                    <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 ml-4">
                                    ...
                                    <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                        <p>
                                            <select style="width:100%;padding: 6px 0;" name="chonnghe" ><option value="0">Chọn ngành</option><option value="1">Tài chính/Kế toán</option><option value="2">Kinh doanh/Bán hàng</option><option value="3">Dịch vụ</option><option value="4">Giáo dục/Luật sưsư</option><option value="5">Điện tử/Game</option></select>
                                    ...
                                    <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                        <p>
                                            <select style="width:100%;padding: 6px 0;" name="chonnoi" ><option value="0">Chọn nơi</option><option value="1">Hà lội</option><option value="2">Đà nẻn</option><option value="3">Tây nguyên</option><option value="4">Tp.HCM</option><option value="5">Cần Thơ</option></select>
                                    ...
                                    <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 ">
                                        <textarea style="height: 135px; width: 100%;" id="career_obj" name="career_obj" class="mb-3 input-text  validate[required,minSize[5],maxSize[1000]] font13 input-has-tooltip select_form_ttc inputbox-success" data-errormessage-value-missing="Yêu cầu nhập mục tiêu nghề nghiệp." > ok...</textarea>
                                    </div>
                            ...
                            <div class="media boder p-3 sv8-12 mt-3 mb-3">
                                <div class="row col-sm-12"style="background-image: linear-gradient(-25deg, #8a8a8a 0%, #82dcff 100%);margin:auto;">
                                    ...
                                    <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                        <p>
                                            <select style="width:100%;padding: 6px 0;" name="kynang" ><option value="0">Tinh thông thập bát ban võ nghệ</option><option value="1">Lãnh đạo</option><option value="2">Làm việc nhóm</option><option value="3">Quản lý giao tiếp</option><option value="4">Quản lý stress</option><option value="5">Quản lý dự án</option></select>
                                        </p>
                                    </div>
                                    <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 ml-4">
                                    ...
                                    <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                        <textarea style="height: 150px; width: 100%;" id="career_obj" name="career_obj" class="mb-3 input-text  validate[required,minSize[5],maxSize[1000]] font13 input-has-tooltip select_form_ttc inputbox-success" data-errormessage-value-missing="Yêu cầu nhập mục tiêu nghề nghiệp."> ok...</textarea>
                                    </div>
                                ...
                                <div class="row col-sm-12"style="background-image: linear-gradient(-25deg, #8a8a8a 0%, #82dcff 100%);margin:auto;">
                                    ...
                                    <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 taohoso text-center">
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-2 mr-1"style="background-color: rgb(211, 234, 255);">Trungbình</div>
                                    ...
                                    <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 ">
                                        <textarea style="height: 150px; width: 100%;" id="career_obj" name="career_obj" class="mb-3 input-text  validate[required,minSize[5],maxSize[1000]] font13 input-has-tooltip select_form_ttc inputbox-success" > ok...</textarea>
                                    </div>
                                    ...
                                    <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                        <p>
                                            <select style="padding: 6px 0px; width: 36%;" name="ngoaingu" ><option selected value="0">Ngôn ngữ</option><option value="1">Tiếng Anh</option><option value="2">Tiếng Trung</option><option value="3">Tiếng Nhật</option><option value="4">Tiếng Tây Ban Nha</option><option value="5">Tiếng Do Thái</option><option value="6">Pháp</option></select>
                                        </p> 
                                    </div>
                                    <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 ml-4">
                                        <p> &nbsp; </p>
                                    ...
                                    <div class="col-12 text-center mb-4">
                                        <button class="buttonhuy ml-4 " type="button" >
                                            + Thêm ngôn ngữ
                                        </button>
                                    </div>
                            ...
                            <div class="col-12 text-center mt-2 mb-3">
                                <a href="file:///C:/Users/ASUS/Documents/GitHub/quan-ly-thuc-tap/site/view/sv3-qlhoso.html">
                                    <button class="buttoncapnhat ml-4" type="button" onclick="alert('Lưu thành công')">
